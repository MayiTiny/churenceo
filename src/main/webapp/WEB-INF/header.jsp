...
<!--             <a href="###">登录</a> | <a href="###">注册</a> -->
    ...
    <script type="text/javascript" src="http://qzonestyle.gtimg.cn/qzone/openapi/qc_loader.js" data-appid="101180974" data-redirecturi="churenceo.com" data-callback="true" charset="utf-8"></script>
	<script>
	  $(function() {
